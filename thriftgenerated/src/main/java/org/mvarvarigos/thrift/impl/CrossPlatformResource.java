...
public class CrossPlatformResource implements org.apache.thrift.TBase<CrossPlatformResource, CrossPlatformResource._Fields>, java.io.Serializable, Cloneable, Comparable<CrossPlatformResource> {
  ...
  static {
    schemes.put(StandardScheme.class, new CrossPlatformResourceStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CrossPlatformResourceTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.SALUTATION};
  ...
  public CrossPlatformResource setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public CrossPlatformResource setSalutation(String salutation) {
  ...
  public int hashCode() {
    ...
    boolean present_salutation = true && (isSetSalutation());
    builder.append(present_salutation);
    if (present_salutation)
  ...
  public int compareTo(CrossPlatformResource other) {
    ...
    lastComparison = Boolean.valueOf(isSetSalutation()).compareTo(other.isSetSalutation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSalutation()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CrossPlatformResource(");
    boolean first = true;
  ...
  private static class CrossPlatformResourceStandardSchemeFactory implements SchemeFactory {
    public CrossPlatformResourceStandardScheme getScheme() {
      return new CrossPlatformResourceStandardScheme();
    }
  }

  private static class CrossPlatformResourceStandardScheme extends StandardScheme<CrossPlatformResource> {
  ...
  private static class CrossPlatformResourceTupleSchemeFactory implements SchemeFactory {
    public CrossPlatformResourceTupleScheme getScheme() {
      return new CrossPlatformResourceTupleScheme();
    }
  }

  private static class CrossPlatformResourceTupleScheme extends TupleScheme<CrossPlatformResource> {
