...
public class CrossPlatformService {
  ...
  public interface Iface {
    ...
    public List<CrossPlatformResource> getList() throws InvalidOperationException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<CrossPlatformResource> recv_getList() throws InvalidOperationException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getList_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<CrossPlatformResource> getResult() throws InvalidOperationException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class get<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, get_args, CrossPlatformResource> {
      ...
      public AsyncMethodCallback<CrossPlatformResource> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<CrossPlatformResource>() { 
      ...
      public void start(I iface, get_args args, org.apache.thrift.async.AsyncMethodCallback<CrossPlatformResource> resultHandler) throws TException {
    ...
    public static class getList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getList_args, List<CrossPlatformResource>> {
      public getList() {
        super("getList");
      }
      ...
      public AsyncMethodCallback<List<CrossPlatformResource>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<CrossPlatformResource>>() { 
          public void onComplete(List<CrossPlatformResource> o) {
            getList_result result = new getList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getList_args args, org.apache.thrift.async.AsyncMethodCallback<List<CrossPlatformResource>> resultHandler) throws TException {
...
;
  ...
  public static class getList_result implements org.apache.thrift.TBase<getList_result, getList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getList_result>   {
    ...
    public List<CrossPlatformResource> success; // required
    public InvalidOperationException e; // required
    ...
    public getList_result(
      List<CrossPlatformResource> success,
      InvalidOperationException e)
    {
      this();
      this.success = success;
    ...
    public getList_result(getList_result other) {
      if (other.isSetSuccess()) {
        List<CrossPlatformResource> __this__success = new ArrayList<CrossPlatformResource>(other.success.size());
    ...
    public void addToSuccess(CrossPlatformResource elem) {
      if (this.success == null) {
        this.success = new ArrayList<CrossPlatformResource>();
      }
      this.success.add(elem);
    }

    public List<CrossPlatformResource> getSuccess() {
      return this.success;
    }

    public getList_result setSuccess(List<CrossPlatformResource> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<CrossPlatformResource>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CrossPlatformResource>(_list0.size);
                  for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                  {
                    CrossPlatformResource _elem2;
                    _elem2 = new CrossPlatformResource();
                    _elem2.read(iprot);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CrossPlatformResource>(_list5.size);
            for (int _i6 = 0; _i6 < _list5.size; ++_i6)
            {
              CrossPlatformResource _elem7;
              _elem7 = new CrossPlatformResource();
              _elem7.read(iprot);
